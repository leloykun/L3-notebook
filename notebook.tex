...
\section{Data Structures}
	...
	\subsection{Segment Tree}
		\subsubsection{Recursive (Point-update)}
			\code{data-structures/segtree_rec.cpp}
		\subsubsection{Iterative (Point-update \and operation can be non-commutative)}
			\code{data-structures/segtree_iter.cpp}
		\subsubsection{Lazy Propagation (Range-update)}
			\code{data-structures/segtree_lazy.cpp}
		\subsubsection{Persistent (Point-update)}
...
\section{Graphs}
    ...
    \subsubsection{Gomory-Hu (All-pairs Max Flow)}
